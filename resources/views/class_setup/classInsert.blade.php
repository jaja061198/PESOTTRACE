  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
      <div class="col-lg=12">
        <a href="{{ route('student.index') }}" class="btn btn-block btn-success btn-sm"><i class="fa fa-list"></i> Class List </a>
      </div>
              ...
              <form method="post" action="{{ route('student.store') }}">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Subject" name="mname">
                  </div>

                  <div class="form-group">
                     <label for="exampleInputEmail1"><font style="color:red;">*</font>Time</label>
                    <input type="time" class="form-control" placeholder="Enter Subject" name="mname">
                  </div>
